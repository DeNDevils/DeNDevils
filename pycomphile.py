...
banner=("""\033[1;36m
         ...
         \033[1;32m»COMPILER PYTHON«\033[1;36m

                         _\033[1;31m
                        |_|    _\033[1;31m    
                        |_|   |_|\033[1;31m
                     _  |_|_ _|_|\033[1;31m
                    \_\_|_|_|_|_|\033[1;31m
                     \  |_|_|_|_|\033[1;31m
                      \_        /\033[1;31m 


\033[1;31mGithub :https://github.com/ZYCRON
\033[1;31mContact:https://wa.me/6283874961264\033[1;36m
""")
def py():
	try:
		os.system('clear')
		print(banner)
		a=input("\033[1;37mMasukan Nama Filenya=> \033[1;32m")
		x=open(a).read()
		b=compile(x,'','exec')
		c=marshal.dumps(b)
		d=open("Hasil_"+a,'w')
		...
		d.close()
		time.sleep(1.5)
		print("\033[1;32mFile Berhasil Tercompile Say:v: \033[1;36mHasil_"+a)
		print()
